        ...
        <nav class="bg-gray-800">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                @endguest
                                @auth
                                <x-nav-link href="/userMenu" :active="request()->is('/')">Home</x-nav-link>
                            ...
                            <div class="relative ml-3">
                                <div>
                                    <button type="button" class="relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                                        ...
                                        <img class="h-8 w-8 rounded-full" src="https://media.licdn.com/dms/image/D5603AQE9GtawvlmZnA/profile-displayphoto-shrink_400_400/0/1695369239551?e=1726704000&v=beta&t=OAnj4dYHwyn1cL7zl9qSGDzLAK1Mj19tGTuVH__880s" alt="">
                                    </button>
                                </div>
                            </div>
                        </div>
            ...
            <div class="md:hidden" id="mobile-menu">
                <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
                    ...
                    @endguest
                    @auth
                    <x-nav-link href="/" :active="request()->is('/userMenu')">Home</x-nav-link>
                    <x-nav-link href="/deposit" :active="request()->is('register')">Deposit</x-nav-link>
                    <x-nav-link href="/withdraw" :active="request()->is('register')">Withdraw</x-nav-link>
                    <x-nav-link href="/transfer" :active="request()->is('register')">Transfer</x-nav-link>
                    <x-nav-link href="/statement" :active="request()->is('register')">Statement</x-nav-link>
